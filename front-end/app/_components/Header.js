      ...
      <nav className="bg-gradient-to-r from-emerald-700 via-emerald-600 to-teal-600 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
              ...
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-2 rounded-lg text-white hover:bg-white/10 transition-all duration-200 font-medium text-2xl"
                  >
            ...
            {/* Right Navigation */}
            <div className="hidden md:flex items-center space-x-6 relative left-[8rem]">
